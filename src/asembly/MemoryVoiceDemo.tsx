...
import { z } from "zod";
import { FONT, PhoneAssetFrame, PhoneBubble, ScanView, SceneQrCallout, TitleCard } from "./shared";
...
const MemoryScreen: React.FC<{ 說明文字: string }> = ({ 說明文字 }) => {
  return <>
    <Img src={staticFile(A("app_memory_play1.png"))} style={{ position: "absolute", width: "100%" }} />
